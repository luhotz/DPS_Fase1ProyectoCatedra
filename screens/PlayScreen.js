...
<Image
source={{uri:"https://upload.wikimedia.org/wikipedia/en/5/50/RatatouillePoster.jpg"}}
style={styles.album}
/>

<Text style={styles.song}>Le festin</Text>
<Text style={styles.artist}>Camille, Michael Giacchino</Text>
